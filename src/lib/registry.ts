...
const APPS: AppDefinition[] = [
  app({ id: 'scrapper-pro', name: 'Scrapper Pro', description: 'Search public image, video, post, and article sources with in-page previews, local saves, downloads, and signed-in Media Vault archiving.', category: 'utilities', icon: 'Search', route: '/apps/scrapper-pro', tags: ['search', 'media', 'images', 'videos', 'articles', 'vault'], status: 'beta', version: '1.2.0', changelog: [{ version: '1.2.0', date: '2026-09-09', changes: ['Signed-in Save to Media Vault flow', 'Deduplicated source references by original URL', 'Local guest saves remain browser-only', 'Removed new Scrapper saves from Dragon Arena asset storage'] }, { version: '1.1.0', date: '2026-09-08', changes: ['Media-first two-column grid', 'Image/video showbox with arrow navigation', 'Server-backed downloads and article PDF export'] }] }),
  ...
  app({ id: 'media-vault', name: 'Media Vault', description: 'Shared per-user asset surface for private General uploads, linked Dragon Arena scenes, and deduplicated Scrapper Pro source references.', category: 'utilities', icon: 'Lock', route: '/apps/media-vault', tags: ['media', 'storage', 'vault', 'upload', 'quota', 'supabase', 'scrapper'], status: 'beta', version: '1.1.0', changelog: [{ version: '1.1.0', date: '2026-09-09', changes: ['Scrapper Pro saves now use Media Vault directly', 'External reference rows with source deduplication', 'Dragon Arena scenes remain linked from their authoritative game ledger', 'Source-aware deletion and General-only manual upload UX'] }, { version: '1.0.0', date: '2026-09-09', changes: ['Per-user media vault table with 200 MB default quota', 'Direct-to-Supabase signed uploads via user-media.js API', 'Server-side quota enforcement RPC', 'Image/video preview with signed URLs'] }] }),
...
export const APPFORGE_CHANGELOG = [
  { version: '1.21.0', date: '2026-09-09', changes: ['Media Vault becomes the shared Scrapper Pro account ledger', 'Scrapper Pro direct Media Vault archiving with source deduplication', 'Dragon Arena registry metadata synced to current Hugging Face architecture'] },
