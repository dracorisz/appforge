...
const APPS: AppDefinition[] = [
  ...
  app({ id: 'crypto-track', name: 'Crypto Track', description: 'Live cryptocurrency market data through AppForge server APIs with provider failover and watchlists.', category: 'crypto', icon: 'Wrench', route: '/apps/crypto-track', tags: ['crypto', 'prices', 'market', 'coingecko', 'coinpaprika'], status: 'beta', version: '1.2.0', changelog: [{ version: '1.2.0', date: '2026-09-10', changes: ['Moved into the Crypto category', 'Dedicated public route available without authentication'] }] }),
  app({ id: 'weather-now', name: 'Weather Now', description: 'Current weather and location search through AppForge server APIs backed by Open-Meteo.', category: 'utilities', icon: 'CloudSun', route: '/apps/weather-now', tags: ['weather', 'forecast', 'open-meteo', 'city'], status: 'beta', version: '1.3.0', changelog: [{ version: '1.3.0', date: '2026-09-10', changes: ['List mode rebuilt into a compact city, condition, temperature, feels-like, humidity and wind row'] }, { version: '1.2.0', date: '2026-09-09', changes: ['Responsive current-condition cards with stronger visual hierarchy', 'Pressure, cloud cover, visibility, sunrise, and sunset metrics', 'Theme-aware atmospheric surfaces and improved scanability'] }] }),
  app({ id: 'task-list', name: 'Task List', description: 'Local-first TODO tracking with optional authenticated Supabase sync, filters, progress, and inline editing.', category: 'utilities', icon: 'FileText', route: '/apps/task-list', tags: ['tasks', 'todo', 'productivity', 'local-first', 'supabase'], status: 'beta', version: '0.1.0', changelog: [{ version: '0.1.0', date: '2026-09-10', changes: ['Local create, complete and delete workflow', 'Browser persistence', 'Optional authenticated Supabase sync with RLS', 'Shared AppForge shell integration and responsive workspace layout'] }] }),
  app({ id: 'desktop-buddy', name: 'Desktop Buddy', description: 'Create a local dragon character pack that can react to AppForge agent responses, with KDE Konqi starters, browser voice, and provider-ready Hugging Face and Vertex AI paths.', category: 'ai', icon: 'Sparkles', route: '/apps/desktop-buddy', tags: ['ai', 'dragon', 'character', 'avatar', 'konqi', 'kde', 'hugging-face', 'vertex', 'voice', 'local-first'], status: 'beta', version: '0.6.0', changelog: [{ version: '0.6.0', date: '2026-09-10', changes: ['Persistent cross-route companion overlay', 'Browser-local 128/256/512 PNG and WebP optimizer'] }, { version: '0.5.0', date: '2026-09-10', changes: ['Canonical registry entry replaces the temporary registry shim', 'KDE Konqi starter asset gallery with source/license attribution', 'Local character upload, pack import/export, framing and browser voice preview'] }] }),
  ...
  app({ id: 'qr-generator', name: 'QR Generator', description: 'Generate QR codes for URLs, text, or Wi-Fi with downloadable output.', category: 'utilities', icon: 'QrCode', route: '/apps/qr-generator', tags: ['qr', 'generate', 'download'], status: 'beta', version: '0.2.0', changelog: [{ version: '0.2.0', date: '2026-09-10', changes: ['Registry maturity aligned with the existing implementation route'] }] }),
