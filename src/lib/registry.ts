...
const APPS: AppDefinition[] = [
  ...
  app({ id: 'dns-txt-checker', name: 'DNS Checker', description: 'Inspect DNS records and map a domain’s answers.', category: 'utilities', icon: 'Search', route: '/apps/dns-checker', tags: ['dns', 'txt', 'mx', 'records', 'dnssec'], status: 'beta', version: '1.1.0' }),
  ...
  app({ id: 'data-converter', name: 'Data Converter', description: 'Convert JSON, CSV, YAML, XML, Markdown, HTML and encoded text.', category: 'converters', icon: 'ArrowLeftRight', route: '/apps/data-converter', tags: ['data', 'convert', 'json', 'csv'], status: 'beta', version: '1.0.0' }),
