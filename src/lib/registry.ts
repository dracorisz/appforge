...
export const APPFORGE_CHANGELOG = [
  ...
  { version: '1.21.0', date: '2026-09-09', changes: ['Media Vault becomes the shared Scrapper Pro account ledger', 'Scrapper Pro direct Media Vault archiving with source deduplication', 'Story Studio registry metadata synced to current Hugging Face architecture'] },
