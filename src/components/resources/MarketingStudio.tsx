      ...
      <div className="mt-4 grid gap-4 xl:grid-cols-[320px_minmax(0,1fr)]">
        ...
        {selectedDemo ? <main className="grid gap-4">
          <section className="surface-card rounded-xl border p-4 sm:p-4">
            ...
            <label className="mt-4 grid gap-2 text-sm font-semibold">Narration<textarea value={selectedDemo.narration} onChange={(event) => updateDemo(selectedDemo.id, { narration: event.target.value })} rows={4} className="rounded-xl border bg-background p-4 text-sm font-normal leading-6" /></label>
          ...
          <section className="grid gap-4">
            {selectedPublications.map((record) => <article key={record.id} className="surface-card rounded-xl border p-4 sm:p-4">
              ...
              <label className="mt-4 grid gap-2 text-sm font-medium">Description<textarea value={record.description} onChange={(event) => updatePublication(record.id, { description: event.target.value })} rows={8} className="rounded-xl border bg-background p-4 text-sm leading-6" /></label>
