...
export function AdminBlogFeaturedControl() {
  ...
  return <Card className="p-4">
    <div className="flex items-start gap-2"><Star className="mt-2 h-4 w-4 text-muted-foreground" /><div><h2 className="text-sm font-semibold">Featured blog article</h2><p className="mt-2 text-sm text-muted-foreground">Choose the single published article highlighted on the public Blog landing page.</p></div></div>
