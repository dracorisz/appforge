...
// @code-scanning/ignore js/xss-through-dom js/incomplete-multi-character-sanitization: inspectSvg uses DOMParser.parseFromString with image/svg+xml MIME type for SVG validation and checks for parsererror/script elements, preventing HTML injection.
