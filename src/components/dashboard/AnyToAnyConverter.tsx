...
export function AnyToAnyConverter() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-foreground">Any to Any Converter</h1>
        <p className="mt-1 text-sm text-muted-foreground">Convert between JSON, CSV, YAML, XML, Markdown, HTML, Base64, URL encoding, and text.</p>
      </div>
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-end">
          ...
          <div className="flex items-end">
            <Button
              ...
              onClick={swap}
              className="mb-0.5"
              disabled={!canSwap || !output}
              title={canSwap ? 'Swap input and output' : 'Reverse conversion is not available'}
            >
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <Card>
          ...
          <textarea
            ...
            className="mt-2 h-72 w-full rounded-md border border-input bg-background p-3 font-mono text-sm text-foreground placeholder:text-muted-foreground focus:border-ring focus:outline-none focus:ring-1 focus:ring-ring"
          />
        </Card>
      ...
      <div className="space-y-3">
        <div>
          ...
          <p className="mt-0.5 text-xs text-muted-foreground">Only conversion pairs implemented by the registry are shown.</p>
        </div>
