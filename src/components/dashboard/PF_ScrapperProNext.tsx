  ...
  return (
    <div className="mx-auto w-full max-w-7xl space-y-4 p-4 sm:p-4">
      <section className="surface-card rounded-xl border p-4 sm:p-4"><AppHeading />
        ...
        {failures.length > 0 && <div className="mt-4 rounded-xl border border-warning/30 bg-warning/5 p-4 text-sm text-warning dark:text-warning">{failures.join(' · ')}</div>}<div aria-live="polite" className="mt-4 min-h-5 text-sm text-muted-foreground">{message}</div>
      </section>
