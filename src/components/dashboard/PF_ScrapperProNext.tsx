...
export function PF_ScrapperProNext() {
  ...
  return (
    <div className="mx-auto w-full max-w-7xl space-y-5 p-4 sm:p-6">
      ...
      {!loading && visibleResults.length === 0 && <div className="surface-card rounded-xl border p-10 text-center text-sm text-muted-foreground">Search to load public results, or change the active filter.</div>}
      ...
      <section className="rounded-xl border border-border/70 bg-background/60 p-4 text-xs leading-5 text-muted-foreground"><strong className="text-foreground">Save contract:</strong> “Saved to Media Vault” is shown only after Supabase returns and validates the persisted row.</section>
    </div>
  )
}
