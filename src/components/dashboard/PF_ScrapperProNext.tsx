...
export function PF_ScrapperProNext() {
  ...
  return (
    <div className="mx-auto w-full max-w-7xl space-y-5 p-4 sm:p-6">
      <section className="surface-card rounded-2xl border p-5 sm:p-6"><div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between"><AppHeading /><div className="flex flex-wrap gap-2 text-xs text-muted-foreground"><span>{results.length} results</span><span>{selectedIds.size} selected</span><span>{saved.length} local saves</span><span>{vaultSavedUrls.size} vault-confirmed</span></div></div>
