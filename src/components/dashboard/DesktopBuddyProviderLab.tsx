    ...
    <section className="mx-auto w-full max-w-6xl space-y-4" aria-label="Desktop Buddy AI provider lab">
      ...
      <div className="rounded-xl border bg-card p-4 md:p-4">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div><div className="flex items-center gap-2"><Images className="h-5 w-5" /><h2 className="font-semibold">Your generated buddies</h2></div><p className="mt-2 text-sm text-muted-foreground">Private per-user gallery from Media Vault / Desktop Buddies. The newest 24 generations are shown here.</p></div>
