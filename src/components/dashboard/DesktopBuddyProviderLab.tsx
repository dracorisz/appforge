    ...
    <section className="mx-auto w-full max-w-6xl space-y-4" aria-label="Desktop Buddy AI provider lab">
      <div className="rounded-xl border bg-card p-4 md:p-4">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          ...
          <Button type="button" onClick={() => void refreshStatus()} disabled={loadingStatus} size="md">
        ...
        <div className="mt-4 grid gap-4 lg:grid-cols-[minmax(0,1fr)_300px]">
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {lastVertexJob && (
                <Button type="button" onClick={() => void recoverVertex()} disabled={generating} size="md">
      ...
      <div className="rounded-xl border bg-card p-4 md:p-4">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex gap-2">
            <Button type="button" onClick={() => void refreshGallery()} disabled={galleryLoading} size="md">
