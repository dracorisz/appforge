          ...
          return (
            <article key={starter.id} className={`flex h-full min-h-[20rem] flex-col overflow-hidden rounded-xl border bg-background/40 ${active ? 'ring-1 ring-primary/35' : ''}`}>
              ...
              <div className="flex flex-1 flex-col p-4">
                ...
                <p className="mt-2 min-h-10 text-sm leading-5 text-muted-foreground">{starter.note}</p>
                <p className="mt-2 min-h-10 text-sm leading-4 text-muted-foreground">{starter.author}<br />{starter.license}</p>
