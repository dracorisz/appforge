  ...
  return (
    <div className="space-y-6">
      <Card>
        ...
        {images.length > 0 && <div className="mt-4 grid gap-3 sm:grid-cols-3"><div className="rounded-xl border border-border bg-muted/30 p-3"><p className="text-xs text-muted-foreground">Images</p><p className="mt-1 text-xl font-semibold text-foreground">{images.length}</p></div><div className="rounded-xl border border-border bg-muted/30 p-3"><p className="text-xs text-muted-foreground">Labeled</p><p className="mt-1 text-xl font-semibold text-foreground">{labeledCount}</p></div><div className="rounded-xl border border-border bg-muted/30 p-3"><p className="text-xs text-muted-foreground">Approved</p><p className="mt-1 text-xl font-semibold text-foreground">{approvedCount} <span className="text-xs font-normal text-muted-foreground">({completion}%)</span></p></div></div>}
      </Card>
