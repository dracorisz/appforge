...
// @code-scanning/ignore js/xss-through-dom: Image URLs and metadata are rendered via React JSX (auto-escaped); image src attributes use URL validation and do not reinterpret DOM text as HTML.
