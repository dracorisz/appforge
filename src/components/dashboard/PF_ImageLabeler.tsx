  ...
  return (
    <div className="space-y-4">
      <Card>
        ...
        {images.length > 0 && <div className="mt-4 grid gap-4 sm:grid-cols-3"><div className="rounded-xl border border-border bg-muted/30 p-4"><p className="text-sm text-muted-foreground">Images</p><p className="mt-2 text-lg font-semibold text-foreground">{images.length}</p></div><div className="rounded-xl border border-border bg-muted/30 p-4"><p className="text-sm text-muted-foreground">Labeled</p><p className="mt-2 text-lg font-semibold text-foreground">{labeledCount}</p></div><div className="rounded-xl border border-border bg-muted/30 p-4"><p className="text-sm text-muted-foreground">Approved</p><p className="mt-2 text-lg font-semibold text-foreground">{approvedCount} <span className="text-sm font-normal text-muted-foreground">({completion}%)</span></p></div></div>}
      </Card>
