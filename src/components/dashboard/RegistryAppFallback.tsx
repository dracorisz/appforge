  ...
  if (!app) {
    return (
      <Card className="mx-auto max-w-2xl p-4 text-center">
        ...
        <Link to="/apps" className="mt-4 inline-flex min-h-10 items-center gap-2 rounded-xl px-4 text-sm font-medium hover:bg-accent focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"><ArrowLeft className="h-4 w-4" /> Back to apps</Link>
      </Card>
    )
  }
    ...
    <div className="mx-auto max-w-3xl space-y-4">
      <Card className="p-4">
        ...
        <div className="mt-4 flex flex-wrap gap-4">
          ...
          <a href="https://docs.sstoken.space/PROJECT-PULSE" target="_blank" rel="noreferrer" className="inline-flex min-h-10 items-center gap-2 rounded-xl border border-border px-4 py-2 text-sm font-medium hover:bg-accent focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring">Project status <ExternalLink className="h-4 w-4" /></a>
        </div>
      </Card>
    </div>
  )
