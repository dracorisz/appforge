      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold">Local asset optimizer</h2>
          </div>
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-3">
            {variants.map((variant) => (
              <article key={variant.size} className="overflow-hidden rounded-xl border bg-background/45">
                <div className="grid aspect-square place-items-center bg-muted/35 p-4">
                  <img src={variant.pngUrl} alt={`${variant.size}px optimized preview`} className="h-full w-full object-contain" />
                </div>
