        ...
        <section className="mx-auto mt-8 max-w-3xl border-y border-border/60 py-4" aria-label="Filter apps">
          <div className="grid gap-2 sm:grid-cols-[minmax(0,1fr)_200px]">
            <label className="relative block">
              ...
              <input value={query} onChange={(event) => setQuery(event.target.value)} placeholder="Search apps…" className="w-full rounded-xl border border-border/70 h-8 bg-background/45 pl-8 pr-8 text-xs outline-none focus:ring-1 focus:ring-ring/30" />
