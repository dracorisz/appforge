...
export function PublicFooter() {
  return <footer className="mt-auto shrink-0 border-t border-border/60">
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-4 px-4 py-4 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between sm:px-4 lg:px-8">
