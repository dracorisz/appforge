...
export function HuggingFaceGalleryPage() {
  ...
  return (
    <div className="min-h-screen bg-[#060a11] text-foreground">
      <header className="sticky top-0 z-40 border-b border-white/10 bg-[#060a11]/90 backdrop-blur-xl"><div className="mx-auto flex h-14 max-w-7xl items-center gap-3 px-4 sm:px-6 lg:px-8"><Link to="/" className="flex min-w-0 items-center gap-2.5"><img src="/favicon.svg" alt="AppForge" className="h-8 w-8 shrink-0" /><div className="min-w-0"><div className="truncate text-sm font-semibold text-white">AppForge × Hugging Face</div><div className="truncate text-[11px] text-white/45">Creator-selected Story Studio showcase</div></div></Link><div className="ml-auto flex items-center gap-2"><BuildBadge compact /><Link to="/apps/ai-dragon-arena" className="rounded-lg border border-white/10 bg-white/5 px-3 py-1.5 text-xs font-medium text-white/80 hover:bg-white/10 hover:text-white">Open Story Studio</Link></div></div></header>
