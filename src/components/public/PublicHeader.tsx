    ...
    <header className={`sticky top-0 z-40 border-b border-border/60 bg-black/90 backdrop-blur-xl ${className}`}>
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
        <Link to="/landing" className="group inline-flex items-center gap-3 rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background">
          <img src={APPFORGE_MARK} alt="AppForge" className="h-10 w-10 shrink-0 rounded-xl shadow-sm" decoding="async" />
        ...
        <nav className="flex flex-wrap items-center justify-end gap-2" aria-label="Public navigation">
          <a href="https://paypal.me/dracorisz" target="_blank" rel="noopener noreferrer" aria-label="Support AppForge via PayPal" title="Support AppForge" className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-border/70 bg-background/70 text-muted-foreground transition-[border-color,background-color,color,box-shadow] hover:border-foreground/25 hover:text-foreground hover:shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"><Heart className="h-4 w-4" /></a>
          <Link to="/explore" className={navItemClass}>Apps</Link>
          <Link to="/huggingface" className={navItemClass}><Sparkles className="h-4 w-4" /><span className="hidden md:inline">Hugging Face</span></Link>
