...
export function PrivacyPolicyPage() {
  return (
    <LegalShell title="Privacy Policy" intro="This policy explains how AppForge handles account information, workspace data, tool inputs, Google sign-in data, cookies, and browser storage while the service is in public beta.">
      ...
      <section><h2>2. Google API user data</h2><p>AppForge uses Google user data only to authenticate you, identify your account, display basic profile information, and associate your workspace data with your authenticated user ID. AppForge does not request access to Gmail, Drive, Calendar, Contacts, or other Google services as part of the normal sign-in flow.</p><p><strong>AppForge's use and transfer of information received from Google APIs to any other app will adhere to Google API Services User Data Policy, including the Limited Use requirements.</strong></p><ul><li><strong>No advertising:</strong> AppForge does not use or transfer Google user data for advertising, retargeting, personalized advertising, or interest-based advertising.</li><li><strong>Restricted human reading:</strong> AppForge does not permit humans to read Google user data except with the user's affirmative agreement for specific messages or files, when necessary for security investigations, to comply with applicable law, or when data has been aggregated and anonymized for internal operations.</li><li><strong>Feature scope limitation:</strong> Google user data is used only to provide or improve user-facing features that are prominent in AppForge's interface.</li><li><strong>No generalized AI/ML training:</strong> Google user data is not used to develop, improve, or train generalized or non-personalized AI or machine-learning models.</li></ul></section>
      <section><h2>3. Tool and AI inputs</h2><p>Some tools process data locally in your browser. Server-backed tools may send the minimum information needed to AppForge server functions. AI-powered features process only the input required for the user-requested feature. Do not submit secrets or information you do not want processed by the relevant service.</p></section>
