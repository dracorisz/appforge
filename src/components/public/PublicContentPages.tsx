...
function VideoBlock({ url }: { url?: string }) {
  if (!url) return <div className="mt-8 rounded-xl border border-dashed border-border/80 bg-background/45 p-6"><div className="flex items-center gap-2 font-semibold"><Clapperboard className="h-4 w-4" /> Video walkthrough</div><p className="mt-2 text-sm leading-6 text-muted-foreground">No walkthrough has been published yet.</p></div>
