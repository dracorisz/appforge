    ...
    <article className="group overflow-hidden rounded-xl border border-white/10 bg-[#080d16] transition-transform duration-200 hover:-translate-y-0.5">
      <div className="relative aspect-[16/10] overflow-hidden bg-slate-950">
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent px-4 pb-4 pt-8 sm:px-4 sm:pb-4">
          ...
          <p className="mt-2 text-sm text-white/55">Visual storytelling showcase</p>
        </div>
        <div className="pointer-events-none absolute left-3 top-3 inline-flex items-center gap-2 rounded-xl border border-white/15 bg-black/55 px-2 py-2 text-sm font-medium text-white backdrop-blur-sm">
      ...
      <div className="flex items-center justify-between gap-4 border-t border-white/10 px-4 py-4">
        <p className="line-clamp-1 text-sm text-white/50">A short look at Story Studio’s visual direction.</p>
        <a href={TEASER_WATCH_URL} target="_blank" rel="noreferrer" className="inline-flex shrink-0 items-center gap-2 rounded-xl border border-white/10 bg-black/35 px-2 py-2 text-sm font-medium text-white/75 backdrop-blur hover:bg-white/10 hover:text-white">
