...
const iconMap: Record<string, React.ComponentType<{ className?: string }>> = { ArrowLeftRight, Binary, Braces, Calendar, Code, FileCode, FileText, Hash, Image: ImageIcon, Lock, Palette, QrCode, Regex, Search, Table2, Type, Video, Wrench }
