          ...
          <section className="grid items-stretch gap-4 lg:grid-cols-[minmax(0,0.82fr)_minmax(0,1.18fr)]" aria-labelledby="landing-title">
            ...
            <div className="surface-card overflow-hidden rounded-xl border">
              <div className="flex items-center justify-between gap-4 border-b border-border p-4">
                ...
                <a href={videoUrl} target="_blank" rel="noopener noreferrer" className="shrink-0 text-sm font-medium text-foreground underline-offset-4 hover:underline focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-ring">
                  Open video
                </a>
              </div>
              {videoEmbedUrl ? (
          ...
          >
            <div className="w-full max-w-md rounded-xl border border-border bg-background p-4 shadow-xl">
              ...
              <div className="mt-4 grid grid-cols-2 gap-2">
                <Button variant="primary" style={{ backgroundColor: "#4285F4", borderColor: "#4285F4", color: "#fff" }} onClick={() => void login("google")} disabled={Boolean(busyProvider) || loading}>
