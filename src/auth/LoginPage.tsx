...
import { ArrowLeftRight, ArrowRight, Check, Cloud, Github, Lock, Search, ShieldCheck, Sparkles, Swords } from 'lucide-react'
        ...
        <main className="grid flex-1 items-center gap-10 py-12 lg:min-h-0 lg:grid-cols-[1.15fr_0.85fr] lg:gap-8 lg:py-5">
          <section className="max-w-2xl">
            ...
            <div className="mt-8 lg:mt-5">
              ...
              <a href="https://github.com/dracorisz/appforge" target="_blank" rel="noreferrer" className="mt-2 inline-flex items-center justify-center gap-2 rounded-lg border border-border/70 bg-background/50 px-4 py-2 text-sm font-medium text-muted-foreground hover:border-foreground/20 hover:text-foreground"><Github className="h-4 w-4" /> Follow development</a>
            </div>
