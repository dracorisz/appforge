...
const CLUESO_EMBED_URL = 'https://watchclueso.com/embed/yar8ybku5zii8l1r'
  ...
  return (
    <div className="min-h-dvh overflow-x-hidden bg-background text-foreground">
      <div className="relative isolate flex min-h-dvh flex-col overflow-hidden">
        ...
        <main className="mx-auto w-full max-w-7xl flex-1 px-4 pb-12 pt-6 sm:px-6 sm:pt-10 lg:px-8">
              ...
              <div className="rounded-[2rem] border border-border/70 bg-background/75 p-4 shadow-2xl shadow-foreground/5 backdrop-blur-xl sm:p-5">
                <div className="flex items-center justify-between gap-4 border-b border-border/60 pb-4">
                  <div className="flex items-center gap-3">
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-border/70 bg-background"><img src="/appforge-mark.svg" alt="" className="h-8 w-8" /></div>
          ...
          <section className="mt-14 border-t border-border/60 pt-10" aria-labelledby="walkthrough-title">
            <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">A guided Clueso walkthrough of the current AppForge experience. The recording is embedded directly and loads only when the browser reaches this section.</p>
              </div>
            </div>
            <div className="overflow-hidden rounded-2xl border border-border/70 bg-black/5 shadow-xl shadow-foreground/5">
              <iframe
                src={CLUESO_EMBED_URL}
